...
def apply_behavior_decisions(
    ...
    for decision in normalized_decisions:
        ...
        behavior = Behavior(
            ...
            generated_json_paths=proposal.generated_json_paths,
            omitted_or_empty_json_paths=proposal.omitted_or_empty_json_paths,
            deterministic_structure_json_paths=proposal.deterministic_structure_json_paths,
            normalized_enrichment_hash=proposal.normalized_enrichment_hash,
            ai_contribution_manifest=proposal.ai_contribution_manifest,
            validated_proposal_hash=proposal.validated_proposal_hash,
            local_ai_enrichment=proposal.local_ai_enrichment,
